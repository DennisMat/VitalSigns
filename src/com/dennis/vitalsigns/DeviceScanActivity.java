        ...
        listviewHearRateMonitors.setOnItemClickListener(
        		new AdapterView.OnItemClickListener() {   	
		          ...
		          public void onItemClick(AdapterView<?> parent, final View view,
		            ...
		            //put devise into storage I guess
		            textViewDeviceSelected.setText("You have selected the device: " + device.getName() + "  " + device.getAddress());
		            
		           
		            
		            final HearRateDevice hr = new HearRateDevice(getApplicationContext(),device.getAddress());
	        ...
	        public void onLeScan(final BluetoothDevice device, int rssi, byte[] scanRecord) {
	            runOnUiThread(new Runnable() {
	                ...
	                public void run() {
	                	 ...
	                	 Log.i("sometag", "line 1");
	                     mLeDeviceListAdapter.notifyDataSetChanged();
	                	 Log.i("sometag", "line 2");
	                     /*
	                	  if(!mLeDevices.contains(device)) {
	                          mLeDevices.add(device);
	                          
	                          
	  	                    //TODO: Dennis support many heart rate monitors and other sensor in future versions
	  	                	//check if the device is mio alpha and show it in the text box.
	                          String textString="";
	  	                	 for(int i=0;i<mLeDevices.size();i++){
	  		                   ...
	  		                   textString+=deviceName + " " +deviceAddress;
	  		                     if (deviceName != null && deviceName.length() > 0){
	  		                    	 textViewDeviceExists.setText(textString);
	  		                     }else{
	  		                         
	  		                     }
	  		                	
	  		                	//textViewDeviceExists.setText("The Mio Alpha Heart Rate Monitor has been detected");	                          
	                      }
